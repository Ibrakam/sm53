...
from database.postservice import add_user_post_db, get_all_posts_db, get_exact_post_db, change_post_db, delete_post_db
...
async def change_post_api(post_id: int, new_info: str):
    result = change_post_db(post_id, new_info)
    return result_message(result)
